...
<template>
  <div class="shop-header">
    ...
    <div class="shop-header__announcement op-ellipsis">
  ...
  <VanActionSheet class="shop-header__action-sheet" v-model:show="isPopupShown" title="hong bao yaw wei">
    <div class="content">
      <h4>红包</h4>
