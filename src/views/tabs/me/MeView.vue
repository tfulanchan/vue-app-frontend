...
<template>
  <div class="me-page op-fullscreen">
    <div class="me-page_top">
      <img class="avatar" src="" />
      <div class="name" @click="gotoLogin">qing dang lu</div>
      <div class="account op-then-border">zhang hou deng lu</div>
    </div>
    <OpLoadingView :loading="pending" type="skeleton">
      <div class="me-page_super-card">
        <div class="super-card__left">
          <div class="super-card__left__top">
            <img class="card-img" src="@/assets/imgs/me_page/super-card.png" />
            <div class="divider"></div>
            <div class="bean">chi huo dou:  </div>
      ...
      <div class="me-page_card" v-for="v in data.cards" :key="v.label">
        <div class="me-page__card__title">{{ v.label }}</div>
        <div class="me-page__card__items">
          <div class="me-page__card__item" v-for="cv in v.items"
          :key="cv.iconUrl">
          <VanIcon :name="cv.iconUrl" :size="v.size"></VanIcon>
          <div class="label">
            {{ cv.label }}
            <span v-if="cv.count" class="count">
              {{ cv.count }}
            </span>
          </div>
        </div>
